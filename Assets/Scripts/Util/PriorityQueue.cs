...
namespace Util
{
    ...
    public class PriorityQueue<T> where T : IWeighted
    {
        ...
        private void RunEnqueueRules(int index)
        {
            ...
            if (!(_internal[index].Weight < _internal[parentIndex].Weight)) return;
        ...
        private void RunDequeueRules(int index)
        {
            ...
            if (!(_internal[biggerChildIndex].Weight < _internal[index].Weight)) return;
